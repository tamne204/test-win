        ...
        <?php if ($user_info): ?>
            ...
            <div class="dash-header">
                ...
                <div style="display:flex;gap:10px">
                    ...
                    <a href="/downloads/SlideshowBuilder_Windows_latest.zip" class="btn-outline">📥 Tải Bản Cài Đặt (v2.2.3.18)</a>
                </div>
            </div>
        ...
        <?php else: ?>
            ...
            <section class="hero">
                ...
                <div class="hero-cta">
                    ...
                    <a href="#download" class="btn-secondary btn-lg">📥 Tải Bản Cài Đặt (v2.2.3.18)</a>
                </div>
            ...
            <section id="products" style="padding:40px 0 60px">
                ...
                <div id="ptab-video" class="prod-tab-content" style="display:block">
                    ...
                    <div style="background:#101626;border:1px solid #6366f1;border-radius:18px;padding:28px;margin-bottom:40px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px">
                        <div>
                            <span class="badge badge-active" style="margin-bottom:8px;display:inline-block">BẢN CHÍNH THỨC v2.2.3.18</span>
            ...
            <section id="download" style="padding:40px 0 60px;scroll-margin-top:80px">
                <div style="text-align:center;margin-bottom:32px">
                    ...
                    <h2 class="sec-title" style="font-size:32px">TẢI VỀ PHIÊN BẢN MỚI NHẤT (v2.2.3.18)</h2>
